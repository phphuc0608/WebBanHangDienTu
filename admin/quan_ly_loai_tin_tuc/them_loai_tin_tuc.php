...
<body>
  <div class="container-fluid px-0">
    ...
    <form onsubmit="return check_form();" action="/<?php echo $root; ?>/admin/quan_ly_loai_tin_tuc/xu_ly_them_loai_tin_tuc.php" method="post" id="main" class="row no-gutters p-3">
			<?php 
